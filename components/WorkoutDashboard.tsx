...
const WorkoutDashboard = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-gray-50 md:bg-white relative">
        ...
        {activeTab === 'nutrition' ? (
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar flex flex-col">
            ...
            <div className="flex-1 w-full max-w-6xl mx-auto p-4 md:p-8 flex flex-col md:block pb-24 md:pb-8">
              ...
              {/* Mobile Reset Button (Inside scrollable area) */}
      ...
      <div className="bg-white border-t border-gray-200 p-2 pb-6 md:pb-2 sticky bottom-0 z-40 flex justify-around items-center shadow-lg-up">
        <button 
          onClick={() => setActiveTab('workout')}
          className={`flex flex-col items-center gap-1 p-2 rounded-xl transition-all w-full ${
            activeTab === 'workout' ? 'text-brand-600 bg-brand-50' : 'text-gray-400 hover:bg-gray-50'
          }`}
        >
        ...
        <button 
          ...
          className={`flex flex-col items-center gap-1 p-2 rounded-xl transition-all w-full ${
            activeTab === 'nutrition' ? 'text-orange-500 bg-orange-50' : 'text-gray-400 hover:bg-gray-50'
          }`}
        >
           <Utensils size={24} className={activeTab === 'nutrition' ? 'fill-current' : ''} />
