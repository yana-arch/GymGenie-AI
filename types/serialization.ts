...
export class TypeSafeSerializer {
   ...
   */
  static safeSerialize<T>(data: T, schema: z.ZodSchema<T>): { success: true; data: string } | { success: false; error: Error } {
    try {
   ...
   */
  static safeDeserialize<T>(jsonString: string, schema: z.ZodSchema<T>): { success: true; data: T } | { success: false; error: Error } {
    try {
...
export class DomainSerializers {
  ...
  static deserializeUserProfile(jsonString: string): EnhancedUserProfile {
    return TypeSafeSerializer.deserialize(jsonString, Schemas.EnhancedUserProfile);
  }

  static safeDeserializeUserProfile(jsonString: string): { success: true; data: EnhancedUserProfile } | { success: false; error: Error } {
    return TypeSafeSerializer.safeDeserialize(jsonString, Schemas.EnhancedUserProfile);
  }
  ...
  static serializeWorkoutSession(session: EnhancedWorkoutSession): string {
    return TypeSafeSerializer.serialize(session, Schemas.EnhancedWorkoutSession);
  }
  ...
  static serializeWorkoutPlan(plan: EnhancedWorkoutPlan): string {
    return TypeSafeSerializer.serialize(plan, Schemas.EnhancedWorkoutPlan as any);
  }

  static deserializeWorkoutPlan(jsonString: string): EnhancedWorkoutPlan {
    return TypeSafeSerializer.deserialize(jsonString, Schemas.EnhancedWorkoutPlan as any);
  }

  static safeDeserializeWorkoutPlan(jsonString: string): { success: true; data: EnhancedWorkoutPlan } | { success: false; error: Error } {
    return TypeSafeSerializer.safeDeserialize(jsonString, Schemas.EnhancedWorkoutPlan as any);
  }
  ...
  static serializeExercise(exercise: EnhancedExercise): string {
    return TypeSafeSerializer.serialize(exercise, Schemas.EnhancedExercise as any);
  }

  static deserializeExercise(jsonString: string): EnhancedExercise {
    return TypeSafeSerializer.deserialize(jsonString, Schemas.EnhancedExercise as any);
  }
  ...
  static deserializeWorkoutDay(jsonString: string): EnhancedWorkoutDay {
    return TypeSafeSerializer.deserialize(jsonString, Schemas.EnhancedWorkoutDay as any);
  }
  ...
  static serializeWorkoutWeek(week: EnhancedWorkoutWeek): string {
    return TypeSafeSerializer.serialize(week, Schemas.EnhancedWorkoutWeek as any);
  }

  static deserializeWorkoutWeek(jsonString: string): EnhancedWorkoutWeek {
    return TypeSafeSerializer.deserialize(jsonString, Schemas.EnhancedWorkoutWeek as any);
  }
}
...
export class BatchSerializer {
  ...
  static serializeBatch<T>(items: T[], schema: z.ZodSchema<T>): string {
    try {
      ...
      throw new SerializationError(
        `Failed to serialize batch: ${error instanceof Error ? error.message : 'Unknown error'}`,
        items,
        'serialize'
      );
    }
  ...
  static deserializeBatch<T>(jsonString: string, schema: z.ZodSchema<T>): T[] {
    try {
      ...
      if (!Array.isArray(parsed)) {
        throw new SerializationError('Expected array for batch deserialization', jsonString, 'deserialize');
      }
      ...
      throw new SerializationError(
        `Failed to deserialize batch: ${error instanceof Error ? error.message : 'Unknown error'}`,
        jsonString,
        'deserialize'
      );
    }
...
export class SchemaMigrator {
   ...
   */
  static registerMigration(fromVersion: string, toVersion: string, migrationFn: (data: any) => any): void {
  ...
  static deserializeWithMigration<T>(
    ...
    try {
      ...
      if (parsed.version && parsed.version !== currentVersion) {
        const migratedData = this.migrate(parsed, parsed.version, currentVersion);
...
export const SerializationUtils = {
   ...
   */
  safeValidate<T>(obj: unknown, schema: z.ZodSchema<T>): { success: true; data: T } | { success: false; error: Error } {
    try {
