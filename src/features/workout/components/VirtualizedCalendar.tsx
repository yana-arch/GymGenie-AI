              ...
              <div className="flex items-center justify-between mb-3">
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    <h4 className={`font-bold text-lg ${isSelected ? 'text-brand-900' : 'text-gray-900'}`}>
                      Week {week.weekNumber}
                    </h4>
                    <ChevronRight 
                      size={16} 
                      className={`transition-transform ${isSelected ? 'rotate-90 text-brand-600' : 'text-gray-400'}`} 
                    />
                  </div>
    ...
    return (
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4">
        ...
        <div className="flex flex-col items-center justify-center h-40 text-center text-gray-400">
          ...
          <p className="text-sm font-medium text-gray-600">No workout plan available</p>
